...
export interface ScrapPdfMeta {
  version: 'SCRAP_PDF_V1' | string;
  templateName: 'FICHA_SAIDA_SUCATA_FORNECEDOR_EQUIV' | string;
  generatedAt: string;
  generatedBy: {
    id: string;
    name: string;
...
export type ChecklistCustomData = Record<string, any> & {
...
export interface ChecklistEntry {
  ...
  createdAt: number;
  managerId: string;
  customData?: ChecklistCustomData;
  brasiltec?: {
    present: boolean;
    userId?: string;
